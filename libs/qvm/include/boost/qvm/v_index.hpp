    ...
    qvm
        ...
        qvm_detail
            ...
            vector_r<N,N>
                ...
                ir( A const &, int i )
                    {
                    typedef char dim_[v_traits<A>::dim];
        ...
        typename boost::enable_if_c<
            is_v<A>::value &&
            !qvm_detail::v_index_read_defined<v_traits<A>::dim>::value,
            typename v_traits<A>::scalar_type>::type
        v_index_read( A const & a, int i )
            {
            return qvm_detail::vector_r<0,v_traits<A>::dim>::ir(a,i);
            }
        ...
        typename boost::enable_if_c<
            is_v<A>::value &&
            !qvm_detail::v_index_write_defined<v_traits<A>::dim>::value,
            typename v_traits<A>::scalar_type &>::type
        v_index_write( A & a, int i )
            {
            return qvm_detail::vector_w<0,v_traits<A>::dim>::iw(a,i);
            }
