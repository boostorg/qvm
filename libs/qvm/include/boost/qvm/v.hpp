...
boost
    ...
    qvm
        ...
        qvm_detail
            ...
            to_string_vector_elements
                ...
                f( A const & a )
                    ...
                    return to_string(v_traits<A>::template r<I>(a))+','+to_string_vector_elements<I+1,DimMinusOne>::f(a);
                    }
                };
            ...
            to_string_vector_elements<DimMinusOne,DimMinusOne>
                ...
                f( A const & a )
                    {
                    using namespace qvm_to_string_detail;
                    return to_string(v_traits<A>::template r<DimMinusOne>(a));
                    }
                };
            }
        ...
        typename boost::enable_if_c<
            is_v<A>::value  &&
            !qvm_detail::to_string_v_defined<v_traits<A>::dim>::value,
            std::string>::type
        to_string( A const & a )
            {
            return '('+qvm_detail::to_string_vector_elements<0,v_traits<A>::dim-1>::f(a)+')';
            }
